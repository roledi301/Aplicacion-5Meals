            ...
            <div class="col-lg-2 col-md-2 col-sm-2 ">
                <div class="text-center">
                    <a class="btn" href="{{route('admin.create')}}"
                       role="button" data-toggle="tooltip" data-placement="auto" title="Nuevo usuario">
                        <img src="\images\btns\AddUser.png" style="width:180px;height:180px;border:0;">
                    </a>
                </div>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 ">
                <div class="text-center">
                    <a class="btn" href="{{route('admin.index')}}"
                       role="button" data-toggle="tooltip" data-placement="auto" title="Registro usuario">
                        <img src="\images\btns\EditUser.png" style="width:180px;height:180px;border:0;">
                    </a>
                </div>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 ">
