                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.store') }}">
                    ...
                    <div class="row" style="margin-top: 40px">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 ">
                            <input id="name" type="text" style="font-size: 18px;" class="form-control" name="name" value="{{ old('name') }}" required autofocus>
                            @if ($errors->has('name'))
                    ...
                    <div class="row" style="margin-top: 10px">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 ">
                            <input id="email" type="email" style="font-size: 18px;" class="form-control" name="email" value="{{ old('email') }}" required>
                            @if ($errors->has('email'))
                                <span class="help-block">
                    ...
                    <div class="row" style="margin-top: 50px">
                        <div class="col-lg-1 col-md-1 col-sm-1 col-md-offset-5 col-lg-offset-5 col-sm-offset-5">
                            <button style="border: none" class="button" type="submit" data-toggle="tooltip" data-toggle="tooltip" data-placement="auto" data-toggle="tooltip" data-placement="auto" title="Registrar usuario ">
