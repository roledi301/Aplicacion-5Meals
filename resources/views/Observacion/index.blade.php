<!--LISTA DE OBSERVACIONES DE UN PACIENTE-->
@extends('layouts.app')
                    ...
                    <table class="table table-hover">
                        @if(isset($observaciones))
                            ...
                            <th  style="padding: 0px; padding-top: 10px;border-bottom-width: 0px;" class="col-lg-3 col-md-3 col-sm-3 text-center">
                                <p>Fecha de la observación</p>
                            </th>
                            <th  style="padding: 0px; padding-top: 10px;border-bottom-width: 0px;" class="col-lg-3 col-md-3 col-sm-3 text-center">
                                <p>Hora de la observación</p>
                            </th>
                            <th  style="padding: 0px; padding-top: 10px;border-bottom-width: 0px;" class="col-lg-3 col-md-3 col-sm-3 text-center">
                                <p>Peso</p>
                            </th>
                            ...
                            @foreach($observaciones as $o)<!--for-->
                            ...
                            <tr style="font-size: 20px;align-content: center">
                                <td  style="border-bottom-width: 0px;border-top-width: 0px;" class="col-lg-3 col-md-3 col-sm-3 text-center">
                                    <p style="margin-bottom: 0px;margin-top: 12px;">{{$o->created_at->format('d-m-Y')}}</p>
                                </td>
                                <td  style="border-bottom-width: 0px;border-top-width: 0px;" class="col-lg-3 col-md-3 col-sm-3 text-center">
                                    <p style="margin-bottom: 0px;margin-top: 12px;">{{$o->created_at->format('h:m:s')}}</p>
                                </td>
                                <td  style="border-bottom-width: 0px;border-top-width: 0px;" class="col-lg-3 col-md-3 col-sm-3 text-center">
                                    <p style="margin-bottom: 0px;margin-top: 12px;">{{$o->peso.'&nbsp;&nbsp;&nbsp;Kg'}}</p>
                                </td>
                                ...
                                <td  style="border-bottom-width: 0px;border-top-width: 0px;" class="col-lg-3 col-md-3 col-sm-3 text-center">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 text-center">
                                            <a href="{{route('observaciones.show',$o->id)}}" role="button" class="btn" style="border-width: 0px; padding: 0px;"
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 text-center">
                                            {{ Form::open(['style'=>'margin-bottom: 0px','method' => 'DELETE', 'route' => ['observaciones.destroy2', $o->id, $o->paciente_id]]) }}
                                            {{ Form::image('images\btns\no2.png', 'name', ['class' => 'btn', 'onclick' => 'if(!confirm("¿Está seguro? Recuerda que puedes editar las observaciones"))event.preventDefault();','data-toggle'=>'tooltip', 'data-placement'=>'auto','title'=>'Eliminar observación','style' => 'width: 60px;height: 60px;padding-bottom: 0px;border-bottom-width: 0px;padding-right: 0px;border-top-width: 0px;padding-top: 0px;padding-left: 0px;border-left-width: 0px;border-right-width: 0px;']) }}
                                            {{ Form::close() }}
                                        </div>
                                    </div>
                                </td>
